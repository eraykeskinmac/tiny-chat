...
export default function Angle() {
  const customColorCount = useStore((state) => state.customColors.length);
        ...
        <SliderPrimitive.Thumb asChild aria-label="gradient-angle">
          <div
            className={cn(
              ...
              'focus:ring-1 focus:ring-almost-white focus:ring-offset-1 focus:ring-offset-black',
          ...
          >
            ...
            >
              <span
                className={cn(
                  'absolute left-[calc(50% -1px)] top-0 h-/12 w-0.5 rounded-b-full',
                  'pointer-events-none bg-gradient-to-transparent',
                )}
              />
            </div>
          </div>
